  ...
  const html = `
    ...
    <section class="section" style="background:var(--bg-secondary);">
      <div class="container">
        ...
        <div class="values-grid stagger-children">
          ${[
            { icon: '🤝', title: 'Trust', desc: 'Security begins with trust. We earn it through transparency, reliability, and consistent results.' },
            { icon: '🧠', title: 'Intelligence', desc: 'We use technology and AI to make security smarter, faster, and more effective.' },
            { icon: '⚖️', title: 'Integrity', desc: 'We operate with transparency and responsibility in everything we do.' },
            { icon: '🛡️', title: 'Resilience', desc: 'We prepare organizations for evolving threats and help them bounce back stronger.' },
            { icon: '💡', title: 'Innovation', desc: 'We continuously improve cybersecurity through cutting-edge technology and fresh thinking.' },
            { icon: '🔒', title: 'Protection', desc: 'We protect what matters most — your data, your systems, your people, your business.' },
          ].map(v => `
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="grid grid-4 stagger-children">
          ${[
            { icon: '🛡️', title: 'Protect', desc: 'Protect your digital assets and infrastructure.' },
            { icon: '🔍', title: 'Detect', desc: 'Detect vulnerabilities and threats early.' },
            { icon: '⚡', title: 'Respond', desc: 'Respond effectively to security incidents.' },
            { icon: '📈', title: 'Evolve', desc: 'Continuously evolve your security posture.' },
          ].map(p => `
            <div class="card" style="text-align:center;">
              <div style="font-size:2.5rem;margin-bottom:var(--space-4);">${p.icon}</div>
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="grid grid-4 stagger-children">
          ${[
            { title: 'Cybersecurity', desc: 'Traditional and modern cybersecurity solutions.', color: 'var(--cyber-blue)' },
            { title: 'AI Security', desc: 'Security for AI systems and AI-powered defense.', color: 'var(--ai-purple)' },
            { title: 'Cyber Risk', desc: 'Risk, governance, compliance, and resilience.', color: 'var(--electric-blue)' },
            { title: 'Cyber Defense', desc: 'SOC, MDR, threat detection, and incident response.', color: 'var(--cyan)' },
          ].map(d => `
        ...
        <div class="cta-inner reveal-scale">
          ...
          <div style="position:relative;z-index:1;">
            ...
            <div style="display:flex;gap:var(--space-4);justify-content:center;flex-wrap:wrap;">
              <a href="mailto:info@xecureai.com" class="btn btn-glass btn-lg">Get in Touch</a>
